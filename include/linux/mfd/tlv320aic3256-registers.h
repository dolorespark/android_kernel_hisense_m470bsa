...
#define AIC3256_INT_STICKY_FLAG1		MAKE_REG(0, 42)
#define AIC3256_LEFT_DAC_OVERFLOW_INT	0x80
#define AIC3256_RIGHT_DAC_OVERFLOW_INT	0x40
#define AIC3256_LEFT_ADC_OVERFLOW_INT	0x08
#define AIC3256_RIGHT_ADC_OVERFLOW_INT	0x04

#define AIC3256_INT_STICKY_FLAG2		MAKE_REG(0, 44)
#define AIC3256_LEFT_OUTPUT_DRIVER_OVERCURRENT_INT	0x80
#define AIC3256_RIGHT_OUTPUT_DRIVER_OVERCURRENT_INT	0x40
#define AIC3256_BUTTON_PRESS_INT			0x20
#define AIC3256_HEADSET_PLUG_UNPLUG_INT			0x10
#define AIC3256_LEFT_DRC_THRES_INT			0x08
#define AIC3256_RIGHT_DRC_THRES_INT			0x04

#define AIC3256_INT_STICKY_FLAG3		MAKE_REG( 0, 45)
#define AIC3256_LEFT_AGC_NOISE_INT			0x40
#define AIC3256_RIGHT_AGC_NOISE_INT			0x20
#define AIC3256_INT_FLAG2		MAKE_REG( 0, 46)
#define AIC3256_INT1_CTRL		MAKE_REG( 0, 48)
#define AIC3256_HEADSET_IN_MASK		0x80
#define AIC3256_BUTTON_PRESS_MASK	0x40
#define AIC3256_DAC_DRC_THRES_MASK	0x20
#define AIC3256_AGC_NOISE_MASK		0x10
#define AIC3256_OVER_CURRENT_MASK	0x08
#define AIC3256_OVERFLOW_MASK		0x04
#define AIC3256_SPK_OVERCURRENT_MASK	0x02
#define AIC3256_INT2_CTRL		MAKE_REG( 0, 49)
...
#define AIC3256_GPIO_MFP5_D5_D2    (0b00111100)
#define AIC3256_GPIO_MFP5_D2_SHIFT	(2)
...
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_12 MAKE_REG(44, 12)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_16 MAKE_REG(44, 16)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_20 MAKE_REG(44, 20)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_24 MAKE_REG(44, 24)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_28 MAKE_REG(44, 28)

#define AIC3252_DAC_ADAPTIVE_BANK44_REG_32 MAKE_REG(44, 32)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_36 MAKE_REG(44, 36)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_40 MAKE_REG(44, 40)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_44 MAKE_REG(44, 44)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_48 MAKE_REG(44, 48)

#define AIC3252_DAC_ADAPTIVE_BANK44_REG_52 MAKE_REG(44, 52)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_56 MAKE_REG(44, 56)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_60 MAKE_REG(44, 60)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_64 MAKE_REG(44, 64)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_68 MAKE_REG(44, 68)

#define AIC3252_DAC_ADAPTIVE_BANK44_REG_72 MAKE_REG(44, 72)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_76 MAKE_REG(44, 76)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_80 MAKE_REG(44, 80)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_84 MAKE_REG(44, 84)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_88 MAKE_REG(44, 88)

#define AIC3252_DAC_ADAPTIVE_BANK44_REG_92 MAKE_REG(44, 92)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_96 MAKE_REG(44, 96)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_100 MAKE_REG(44, 100)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_104 MAKE_REG(44, 104)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_108 MAKE_REG(44, 108)

#define AIC3252_DAC_ADAPTIVE_BANK44_REG_112 MAKE_REG(44, 112)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_116 MAKE_REG(44, 116)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_120 MAKE_REG(44, 120)
#define AIC3252_DAC_ADAPTIVE_BANK44_REG_124 MAKE_REG(44, 124)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_8   MAKE_REG(45, 8)


#define AIC3252_DAC_ADAPTIVE_BANK45_REG_20 MAKE_REG(45, 20)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_24 MAKE_REG(45, 24)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_28 MAKE_REG(45, 28)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_32 MAKE_REG(45, 32)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_36 MAKE_REG(45, 36)

#define AIC3252_DAC_ADAPTIVE_BANK45_REG_40 MAKE_REG(45, 40)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_44 MAKE_REG(45, 44)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_48 MAKE_REG(45, 48)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_52 MAKE_REG(45, 52)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_56 MAKE_REG(45, 56)

#define AIC3252_DAC_ADAPTIVE_BANK45_REG_60 MAKE_REG(45, 60)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_64 MAKE_REG(45, 64)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_68 MAKE_REG(45, 68)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_72 MAKE_REG(45, 72)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_76 MAKE_REG(45, 76)

#define AIC3252_DAC_ADAPTIVE_BANK45_REG_80 MAKE_REG(45, 80)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_84 MAKE_REG(45, 84)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_88 MAKE_REG(45, 88)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_92 MAKE_REG(45, 92)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_96 MAKE_REG(45, 96)

#define AIC3252_DAC_ADAPTIVE_BANK45_REG_100 MAKE_REG(45, 100)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_104 MAKE_REG(45, 104)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_108 MAKE_REG(45, 108)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_112 MAKE_REG(45, 112)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_116 MAKE_REG(45, 116)

#define AIC3252_DAC_ADAPTIVE_BANK45_REG_120 MAKE_REG(45, 120)
#define AIC3252_DAC_ADAPTIVE_BANK45_REG_124 MAKE_REG(45, 124)
#define AIC3262_DAC_ADAPTIVE_BANK46_REG_8 MAKE_REG(46, 8)
#define AIC3262_DAC_ADAPTIVE_BANK46_REG_12 MAKE_REG(46, 12)
#define AIC3262_DAC_ADAPTIVE_BANK46_REG_16 MAKE_REG(46, 16)


//adc first order
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_24 MAKE_REG(8, 24)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_28 MAKE_REG(8, 28)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_32 MAKE_REG(8, 32)

#define AIC3252_ADC_ADAPTIVE_BANK9_REG_32 MAKE_REG(9, 32)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_36 MAKE_REG(9, 36)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_40 MAKE_REG(9, 40)

//ADC PART

#define AIC3252_ADC_ADAPTIVE_BANK8_REG_36 MAKE_REG(8, 36)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_40 MAKE_REG(8, 40)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_44 MAKE_REG(8, 44)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_48 MAKE_REG(8, 48)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_52 MAKE_REG(8, 52)

#define AIC3252_ADC_ADAPTIVE_BANK8_REG_56 MAKE_REG(8, 56)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_60 MAKE_REG(8, 60)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_64 MAKE_REG(8, 64)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_68 MAKE_REG(8, 68)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_72 MAKE_REG(8, 72)

#define AIC3252_ADC_ADAPTIVE_BANK8_REG_76 MAKE_REG(8, 76)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_80 MAKE_REG(8, 80)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_84 MAKE_REG(8, 84)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_88 MAKE_REG(8, 88)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_92 MAKE_REG(8, 92)

#define AIC3252_ADC_ADAPTIVE_BANK8_REG_96 MAKE_REG(8, 96)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_100 MAKE_REG(8, 100)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_104 MAKE_REG(8, 104)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_108 MAKE_REG(8, 108)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_112 MAKE_REG(8, 112)

#define AIC3252_ADC_ADAPTIVE_BANK8_REG_116 MAKE_REG(8, 116)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_120 MAKE_REG(8, 120)
#define AIC3252_ADC_ADAPTIVE_BANK8_REG_124 MAKE_REG(8, 124)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_8   MAKE_REG(9, 8)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_12  MAKE_REG(9, 12)

#define AIC3252_ADC_ADAPTIVE_BANK9_REG_44 MAKE_REG(9, 44)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_48 MAKE_REG(9, 48)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_52 MAKE_REG(9, 52)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_56 MAKE_REG(9, 56)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_60 MAKE_REG(9, 60)

#define AIC3252_ADC_ADAPTIVE_BANK9_REG_64 MAKE_REG(9, 64)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_68 MAKE_REG(9, 68)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_72 MAKE_REG(9, 72)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_76 MAKE_REG(9, 76)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_80 MAKE_REG(9, 80)

#define AIC3252_ADC_ADAPTIVE_BANK9_REG_84 MAKE_REG(9, 84)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_88 MAKE_REG(9, 88)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_92 MAKE_REG(9, 92)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_96 MAKE_REG(9, 96)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_100 MAKE_REG(9, 100)

#define AIC3252_ADC_ADAPTIVE_BANK9_REG_104 MAKE_REG(9, 104)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_108 MAKE_REG(9, 108)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_112 MAKE_REG(9, 112)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_116 MAKE_REG(9, 116)
#define AIC3252_ADC_ADAPTIVE_BANK9_REG_120 MAKE_REG(9, 120)

#define AIC3252_ADC_ADAPTIVE_BANK9_REG_124 MAKE_REG(9, 124)
#define AIC3252_ADC_ADAPTIVE_BANK10_REG_8 MAKE_REG(10, 8)
#define AIC3252_ADC_ADAPTIVE_BANK10_REG_12 MAKE_REG(10, 12)
#define AIC3252_ADC_ADAPTIVE_BANK10_REG_16 MAKE_REG(10, 16)
#define AIC3252_ADC_ADAPTIVE_BANK10_REG_20 MAKE_REG(10, 20)
