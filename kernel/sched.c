...
extern void touch_all_hardware_watchdogs(void);
...
void __might_sleep(const char *file, int line, int preempt_offset)
{
	...
	if (irqs_disabled())
        ...
        /* Not panic when only IRQ is disabled e.g. exception handler
          * But always panic for atomic case.
          */
