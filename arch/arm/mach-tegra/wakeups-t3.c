...
static struct tegra_wake_info tegra_wake_event_data_t3[] = {
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PO5), POLARITY_EDGE_ANY},	/* wake0 */
	...
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PW3), POLARITY_EDGE_ANY},	/* wake11 */
	...
	//{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PI5), POLARITY_NONE},	/* wake23 */   //Disable SD detect wakeup
	{-EINVAL, POLARITY_NONE},	/* wake23 */
	...
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PO4), POLARITY_EDGE_ANY},	/* wake32 */
