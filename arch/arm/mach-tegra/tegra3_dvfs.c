...
static struct dvfs cpu_dvfs_table[] = {
	...
	CPU_DVFS("cpu_g",  7, 3, MHZ,   1,   1,   1,   1, 550, 550, 550, 770, 770, 770, 770,  910,  910,  910,  910,  910,  910,  910, 1150, 1150, 1230, 1230, 1230, 1300, 1300, 1370, 1370, 1370, 1440, 1440, 1440, 1500),
	CPU_DVFS("cpu_g",  7, 4, MHZ,   1,   1,   1,   1, 550, 550, 550, 770, 770, 770, 770,  940,  940,  940,  940,  940,  940,  940, 1160, 1160, 1300, 1300, 1300, 1370, 1370, 1370, 1440, 1440, 1440, 1500),
#else
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    1, 1, KHZ,        1, 228000, 275000, 332000, 380000,  448000,  520000,  520000,  520000),
	CORE_DVFS("mpe",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  448000,  520000,  520000,  520000),
	CORE_DVFS("2d",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  448000,  520000,  520000,  520000),
	CORE_DVFS("epp",    1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  448000,  520000,  520000,  520000),
	CORE_DVFS("3d",     1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  448000,  520000,  520000,  520000),
	CORE_DVFS("3d2",    1, 1, KHZ,        1, 234000, 285000, 332000, 380000,  448000,  520000,  520000,  520000),
	CORE_DVFS("se",     1, 1, KHZ,        1, 267000, 285000, 332000, 380000,  448000,  520000,  520000,  520000),
#else
...
#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
	CORE_DVFS("cbus",   1, 1, KHZ,   200000, 228000, 275000, 332000, 380000,  448000,  520000,  520000,  520000),
#else
...
#ifdef CONFIG_TEGRA_GPU_OVERCLOCK
	/* 1200mv == 448mhz / 1250mv == 520mhz */
	user_core_cap.level = 1200;
	user_core_cap.refcnt = 1;
	core_cap_enable(1);
#endif
