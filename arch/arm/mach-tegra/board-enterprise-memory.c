...
extern unsigned int ddr3_det;

static const struct tegra_emc_table enterprise_emc_tables_elpida[] = {
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table enterprise_emc_tables_hynix[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
int enterprise_emc_init(void)
{
        if(ddr3_det == 0)
        {
	    tegra_init_emc(enterprise_emc_tables_elpida,
		        ARRAY_SIZE(enterprise_emc_tables_elpida));
	}
	else
	{
	    //ddr3 = 0x1000
	    tegra_init_emc(enterprise_emc_tables_hynix,
		        ARRAY_SIZE(enterprise_emc_tables_hynix));
	}
	return 0;
}
