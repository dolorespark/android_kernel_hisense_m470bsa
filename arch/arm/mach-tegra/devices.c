...
static struct keyreset_platform_data keyreset_platform_data = {
    .keys_down = {KEY_VOLUMEDOWN, KEY_VOLUMEUP, 0},
};

struct platform_device tegra_keyreset_device = {
	.name	= KEYRESET_NAME,
	.id	= -1,
	.dev = {
		.platform_data = &keyreset_platform_data,
	},
};
