...
static struct i2c_board_info __initdata cardhu_codec_aic325x_info = {
...
static void cardhu_i2c_init(void)
{
	...
	cardhu_codec_wm8903_info.irq = cardhu_codec_max98095_info.irq =
		cardhu_codec_aic325x_info.irq = gpio_to_irq(TEGRA_GPIO_CDC_IRQ);
	i2c_register_board_info(4, &cardhu_codec_wm8903_info, 1);
	i2c_register_board_info(4, &cardhu_codec_max98095_info, 1);
	i2c_register_board_info(0, &cardhu_codec_aic325x_info, 1);
...
static struct tegra_asoc_platform_data cardhu_audio_aic325x_pdata = {
	.gpio_spkr_en = -1,
	.gpio_hp_det = TEGRA_GPIO_HP_DET,
	.gpio_hp_mute = -1,
	.gpio_int_mic_en = -1,
...
#endif
static struct platform_device cardhu_audio_aic325x_device = {
	.name	= "tegra-snd-aic325x",
	.id	= 0,
	.dev	= {
		.platform_data  = &cardhu_audio_aic325x_pdata,
	},
};
...
static noinline void __init cardhu_vibrator_init(void)
{
