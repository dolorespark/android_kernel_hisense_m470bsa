		...
		struct tps80031_regulator_platform_data *tps80031_pdata)
{
	...
	default:
        ...
        if (ri->rinfo->desc.id == TPS80031_REGULATOR_LDO2&&
        	(ri->flags &  TRACK_MODE_ENABLE)) {
        	__tps80031_ldo_set_voltage(parent, ri,tps80031_pdata->reg_init_data->constraints.min_uV
        			        ,tps80031_pdata->reg_init_data->constraints.max_uV, 0);
           //__tps80031_ldo_set_voltage(parent, ri,1*1000*1000,1.2*1000*1000, 0);
        }
