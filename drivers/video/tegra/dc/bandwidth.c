	...
	struct tegra_dc_win *w)
{
	...
	/* [PATCH] video: tegra: dc: Add extra bandwidth in DC for low res video playback, heqi */
//#if defined(CONFIG_BOARD_M470)
	/*
	 * Assuming 70% efficiency: i.e. if we calculate we need 70MBps, we
	 * will request 100MBps from EMC.
	 */
//	ret = ret + (14 * ret / 25);
//#else
